// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.3.2.
...
(function dartProgram() {
  ...
  Y = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(Y.adder__getSum$closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    getSum: function($event) {
      var t1, num1, num2, sum;
      H.interceptedTypeCheck($event, "$isMouseEvent");
      t1 = document;
      num1 = P.int_parse(H.interceptedTypeCast(t1.querySelector("#num1"), "$isInputElement").value);
      num2 = P.int_parse(H.interceptedTypeCast(t1.querySelector("#num2"), "$isInputElement").value);
      if (typeof num1 !== "number")
        return num1.$add();
      if (typeof num2 !== "number")
        return H.iae(num2);
      sum = C.JSInt_methods.toString$0(num1 + num2);
      t1.querySelector("#output").textContent = "" + num1 + " + " + num2 + " = " + sum;
    }
  };
