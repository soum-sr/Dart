...
(function dartProgram() {
  ...
  V = {
    main: function() {
      $.Animal_numberOfAnimals = $.Animal_numberOfAnimals + 1;
      document.querySelector("#output").textContent = "Diana said Bhaww bhaww and weights 12 kg \nDiana runs. \n";
    }
  },
  C = {};
  var holders = [J, P, W, V, C];
